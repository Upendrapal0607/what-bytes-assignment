      ...
      <div className="flex w-full justify-between items-center border-b-2 border-gray-400 px-4 py-6">
        ...
        <div className="flex items-center gap-2">
          <img
            ...
            height={50}
          />
          <h2 className="text-2xl font-bold">Rahil Siddique</h2>
        </div>
      </div>
            ...
            <div className="  flex flex-col items-center bg-white gap-8 w-[100%] py-4 px-0 shadow-lg border-t-[1px]">
              <div className="mt-8 px-4">
                ...
                <p className="text-gray-700 mt-2">
                  You scored{" "}
                  <span className="font-bold">{studentDetails?.correct}</span>{" "}
                  questions correct out of{" "}
                  <span className="font-bold">{total}</span>. However, it still
