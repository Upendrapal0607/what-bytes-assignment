...
const SkillTest = ({setStudentDetails,studentDetails,previousPercentile,setPreviousPercentile}) => {
  ...
  <p className="font-bold">HTML</p>
    ...
    <FormModal isOpen={isModalOpen} onRequestClose={closeModal} setStudentDetails = {setStudentDetails} studentDetails = {studentDetails}/>
        </div>
        ...
        <div className="flex justify-between flex-col font-bold text-lg mb-4 p-4">
          ...
          <div className="text-start flex items-center gap-3">
            ...
            <div>
            <span className="block text-lg font-bold mb-[-10px]">{studentDetails?.rank}</span>
          ...
          <div>
            <span className="block text-lg font-bold mb-[-10px]">{studentDetails?.percentile}%</span>
          ...
          <div className="">
            <span className="block text-lg mb-[-10px] font-bold">{studentDetails?.correct} / 15</span>
